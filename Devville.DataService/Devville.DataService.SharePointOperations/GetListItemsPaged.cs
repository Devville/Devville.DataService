...
namespace Devville.DataService.SharePointOperations
{
    ...
    public class GetListItemsPaged : IServiceOperation
    {
        ...
        public string Description
        {
            ...
            {
                return
                    "Gets SharePoint ListItems Paged with TotalItemCount, it's useful if you want to build pager with number. Parameters are: 'SiteUrl', 'ListUrl', 'ViewName', 'PageSize' and 'PageIndex'. You can 'ConvertToUmAlQura' to true if you want to have create a new date columns to UmAlQura."
